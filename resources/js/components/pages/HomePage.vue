...
export default {
    ...
    methods: {
        ...
        getSubCategories() {
            ...
            const updateFormData = this.allfiltersubcategories.filter(
                (data) =>
                    data.parent_category == this.updateFormdata.category.id
            );
        ...
        getCampaign() {
            try {
                axios
                    .get(baseUrl + `get-campaign?status=yes&no_paginate=yes`)
                    .then((response) => {
            ...
            if (this.form.use_for == "category") {
                if (this.updateFormdata.subcategoryObj != "") {
                    ...
                    this.form.banner[this.updateFormdata.imagenumb].back_link =
                        ...
                        this.updateFormdata.category.id +
                        "&cat_name=" +
                        this.updateFormdata.category.slug;
                }
            }
        ...
        <div class="statbox widget box box-shadow">
            ...
            >
                <div class="row mb-4 mt-3">
                    <div class="col-sm-3 col-12">
                        <div>
                            ...
                            <div class="my-2">
                                ...
                                >
                                    <option selected="single" value="single">
                                        Single
                                    </option>
                            ...
                            <div class="my-2">
                                <label for="set-precedence"
                                    >Set Precedense</label
                                >
                                <input
                                    type="number"
                                    id="set-precedence"
                        ...
                        <div
                            style="margin-top: 30%"
                            v-if="
                                allcategories.length > 0 || campaigns.length > 0
                            "
                        >
                            <p class="text-success" style="font-size: 17px">
                                Create Back Link
                            ...
                            <div class="my-2">
                                <select
                                    id="select-item"
                                    class="form-control"
                                    v-model="updateFormdata.imagenumb"
                                >
                                    <option selected="" value="">
                                        Choose Link
                                    </option>
                                    <option
                                        v-for="(value, index) in form.banner"
                                        :value="index"
                                        :key="index"
                                    >
                                        Back Link No-{{ ++index }}
                            ...
                            <div v-if="form.use_for == 'category'">
                                <div class="my-2">
                                    <select
                                        ...
                                        v-model="updateFormdata.category"
                                    >
                                        <option selected="" value="">
                                            Choose Category
                                        </option>
                                ...
                                <div>
                                    <select
                                        id="product-updateFormdata"
                                        class="form-control"
                                        v-model="updateFormdata.subcategoryObj"
                                    >
                            ...
                            <div v-if="form.use_for == 'campaign'">
                                <div class="my-2">
                                    <select
                                        id="campaign"
                                        class="form-control"
                                        v-model="updateFormdata.subcategory"
                                    >
                                        <option selected="" value="">
                                            Choose Campaign
                                        </option>
                    ...
                    <div
                        class="col-sm-6 border-left col-12"
                        v-if="
                    ...
                    >
                        <div class="tab-content" id="v-border-pills-tabContent">
                            <div
                                class="tab-pane fade active show bordered my-2"
                                v-for="(bann, ind) in form.banner"
                                :key="ind"
                            ...
                            >
                                <input
                                    type="submit"
                                    v-if="
                                        showPermission.includes('page-update')
                                    "
                                ...
                                <video
                                    :src="bann.banner_uri"
                                    autoplay
                                    v-if="bann.file_type == 'video'"
                                    muted
                                    controls
                                    class="controlss"
                                ></video>
                                <v-lazy-image
                                    class="mr-3 controlss"
                                    v-else
                                    :src="bann.banner_uri"
                                    alt="Home image two"
        ...
        <media-helper :setImg="selectImage">
            <template v-slot:viewimage>
                <div class="col-md-12 d-flex justify-content-center my-2">
                    <v-lazy-image
                        :src="updateFormdata.imageuri"
                        class="card-img-top"
                        :alt="updateFormdata.imageuri"
                        :src-placeholder="url + 'demo.png'"
                        v-if="updateFormdata.imagenumb != 'one'"
                    />
                    <video
                        :src="updateFormdata.imageuri"
                        v-else
