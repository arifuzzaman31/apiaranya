...
export default {
    ...
    methods: {
        ...
        addInformation() {
            axios
                .post(baseUrl + `add-information`, this.form)
                .then((response) => {
        ...
        deleteInfo(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .delete(baseUrl + `remove-information-data/${id}`)
                        .then((response) => {
                            this.successMessage(response.data);
                            window.location.reload(true);
                        })
                    ...
                    <div class="row">
                        ...
                        >
                            ...
                            <button
                                ...
                                v-if="showPermission.includes('add-info')"
                                data-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <th
                                        v-if="
                                            ...
                                            showPermission.includes('edit-info')
                                        "
                                        class="text-center"
                                    >
                                        Action
