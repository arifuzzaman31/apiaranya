                                ...
                                <template v-for="(tax,index) in taxes.data" :key="tax.id">
                                    <tr>
                                        ...
                                        <td v-if="showPermission.includes('attribute-edit') || showPermission.includes('attribute-delete')">
                                            <button type="button" v-if="showPermission.includes('attribute-edit')" class="btn btn-sm btn-info-a" data-toggle="modal" data-target="#taxModal" @click="editTax(tax)">Edit</button>
                                            <button type="button" v-if="showPermission.includes('attribute-delete')" class="btn btn-sm btn-delete ml-2" @click="deleteTax(tax.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
