                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between">
                            <h4>VAT / TAX</h4>
                            <button class="btn btn-primary mb-2 mr-3" v-show="showPermission.includes('attribute-create')" data-toggle="modal" data-target="#taxModal" @click="formReset">Add New</button>
                        </div>                          
                    </div>
                </div>       
                                ...
                                <template v-for="(tax,index) in taxes.data" :key="tax.id">
                                    <tr>
                                        ...
                                        <td v-show="showPermission.includes('attribute-edit') || showPermission.includes('attribute-delete')">
                                            <button type="button" v-show="showPermission.includes('attribute-edit')" class="btn btn-sm btn-info" data-toggle="modal" data-target="#taxModal" @click="editTax(tax)">Edit</button>
                                            <button type="button" v-show="showPermission.includes('attribute-delete')" class="btn btn-sm btn-danger ml-2" @click="deleteTax(tax.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
