    ...
    methods: {
        getOrder(page = 1) {
            axios
                .get(
                    baseUrl +
                        `get-order?page=${page}&per_page=10&keyword=${this.search}&byposition=${this.filterdata.order_state}&payment_status=${this.filterdata.payment_status}&status=${this.filterdata.status}`
                )
                .then((result) => {
        ...
        orderModify() {
            axios
                .post(baseUrl + `order/cancel`, this.order_status)
                .then((result) => {
        ...
        paymentModify(id) {
            axios
                .post(
                    baseUrl + `update-payment-status/${id}`,
                    this.order_status
                )
                .then((result) => {
                    this.order_status.order_id = "";
        ...
        updateStatus() {
            axios
                .post(baseUrl + `update/order/status`, this.order_status)
                .then((result) => {
        ...
        orderStatus(data) {
            ...
            axios
                .get(baseUrl + `order-shipment/${data.id}`)
                .then((result) => {
                    this.order_status.order_id = result.data.id;
                    this.order_status.order_position =
                        result.data.order_position;
        ...
        orderDetailModal(order) {
            axios
                .get(baseUrl + `orders-details/${order.id}`)
                .then((result) => {
                ...
                <div class="widget-content widget-content-area">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3 col-lg-2 col-12  my-1">
                            <select
                                ...
                                class="form-control"
                                @change="getOrder()"
                                v-model="filterdata.order_state"
                            >
                    ...
                    <div class="float-right">
                        <a
                            ...
                            :href="
                                url +
                                `get-order?excel=yes&keyword=${search}&byposition=${filterdata.order_state}&status=${filterdata.status}`
                            "
                            type="button"
                            class="btn btn-info-a"
                            ><svg
                            ...
                            <div class="row d-flex justify-content-between">
                                ...
                                >
                                    ...
                                    <p>
                                        ...
                                        {{
                                            shipment_info.user_billing_info
                                                .last_name
                                        }}
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        City:
                                        {{
                                            shipment_info.user_billing_info.city
                                        }}
                                    </p>
                                    <p>
                                        Country:
                                ...
                                <div class="col-md-4 text-right">
                                    ...
                                    <p>
                                        Name:
                                        {{
                                            shipment_info.user_shipping_info
                                                .last_name
                                        }}
                                    </p>
                                    <p>
                                ...
                                >
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            <td>
                                                {{ orderdetail.selling_price }}
                                            </td>
                                            <td>{{ orderdetail.quantity }}</td>
                                            <td>
                                                {{
                                                    orderdetail.total_selling_price
                                                }}
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <form method="post">
                                <div>
                                    ...
                                    >
                                        ...
                                        <select
                                            class="form-control"
                                            v-model="order_status.hub_name"
                                        >
                                            <option value="">Choose One</option>
                                            <option
                                                v-for="point in pickuppoint"
                                                :key="point.id"
                                                :value="point"
                                            >
                                                {{ point.hub_name }}-{{
