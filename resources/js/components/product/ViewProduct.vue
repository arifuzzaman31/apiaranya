...
export default {
    ...
    methods: {
        getProduct(page = 1) {
            try {
                axios
                    .get(
                        baseUrl +
                            `get-product?page=${page}&per_page=${this.filterdata.per_page}&camp_id=${this.filterdata.camp_id}&category=${this.filterdata.category}&subcategory=${this.filterdata.subcategory}&keyword=${this.keyword}`
                    )
                    .then((response) => {
        ...
        getCategory() {
            axios
                .get(baseUrl + "get-category?no_paginate=yes")
                .then((response) => {
                    let res = response.data.filter(
                        (data) => data.parent_category == 0
                    );
                    let subcat = response.data.filter(
                        (data) => data.parent_category !== 0
                    );
        ...
        getSubCategories() {
            const filterData = this.allfiltersubcategories.filter(
                (data) => data.parent_category == this.filterdata.category
            );
        ...
        getHomeSection() {
            axios
                .get(baseUrl + `get-page-section?no_paginate=yes&status=active`)
                .then((response) => {
        ...
        toggleWhatsNew(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .get(baseUrl + `product-whats-new/${id}`)
                        .then((response) => {
                            this.getProduct();
        ...
        handleBulkFileUpload() {
            ...
            document.getElementById("excel-file").innerHTML =
        ...
        uploadExcel() {
            ...
            axios
                .post(baseUrl + "product-import", formData, {
                    headers: {
    ...
    <div class="container-fluid mt-3">
        <div id="toggleAccordion">
            <div class="card">
                ...
                >
                    <div class="card-body">
                        <div
                            class="statbox widget box box-shadow mb-4"
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    <a
                                        ...
                                        "
                                        :href="url + 'product-stock-download'"
                                ...
                                <div class="col mr-1">
                                    <a
                                        type="button"
                                        :href="url + 'product-bulk-download'"
        ...
        <div class="table-responsive">
            ...
            >
                ...
                <tbody>
                    <template
                        v-for="product in allproduct.data"
                        :key="product.id"
                    >
                        <tr>
        ...
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="bulkUploadLabel">
                            Bulk Upload
                        </h5>
                        <button
                            type="button"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form">
                                    <div class="form-group">
                                        <p>
                                            Upload Product According To Excel
                                            Format
                                        </p>
                                        <br />
        ...
        <div
            ...
            tabindex="-1"
            role="dialog"
            aria-labelledby="stockUpdateLabel"
            aria-hidden="true"
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="stockUpdateLabel">
                            Stock Update
                        </h5>
                        <button
                            type="button"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form">
                                    <div class="form-group">
                                        <p>
                                            Upload Stock Update To Excel Format
                                        </p>
                                        <br />
                                        <span class="btn btn-primary btn-file">
                                            <svg
