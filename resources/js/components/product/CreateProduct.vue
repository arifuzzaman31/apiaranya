    ...
    methods: {
        ...
        getSubCategories() {
            const filterData = this.allfiltersubcategories.filter(
                (data) => data.parent_category == this.form.category
            );
        ...
        makeAttrComb() {
            ...
            this.form.attrqty = [];
            if (
                this.choose_colours.length > 0 &&
                this.form.is_color &&
                this.form.is_size &&
                this.choose_sizes.length > 0
            ) {
        ...
        selectImage(item) {
            if (
                this.form.selectedImages &&
                this.form.selectedImages.length < 4
            ) {
...
<template>
    ...
    >
                ...
                <div class="widget-content">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div
                                v-if="
                                    validation_error.hasOwnProperty('category')
                                "
                        ...
                        <div class="form-group col-md-4">
                            ...
                            >
                                ...
                                <option
                                    v-for="(value, index) in allsubcategories"
                                    :value="value.id"
                                    :key="index"
                                >
                                    {{ value.category_name }}
                    ...
                    <div class="row mt-1">
                        <div
                            id="tooltips"
                            class="col-lg-12 layout-spacing col-md-12 px-3"
                        >
                            <div class="widget-content">
                                ...
                                <div class="row">
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            @click="
                                                () =>
                                                    this.form.selectedImages.splice(
                                                        index,
                                                        1
                                                    )
                                            "
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <label for="product-Embellishment"
                                >Embellishment</label
                            >
                            <Multiselect
                ...
                <div class="form-row">
                    <div class="widget-content">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 mb-3">
                                <label for="product-fragile_charge"
                                    >Fragile Charge</label
                                >
                                <input
                                    type="number"
                                    class="form-control form-control-sm"
        ...
        <div
            ...
            v-if="form.has_variation && combine"
        >
            <div class="widget-content">
                <div class="row text-center">
                    <div
                        class="col-2 col-sm-2 text-success"
                        v-show="form.is_color"
                    >
                        <b>Colour</b>
                    </div>
                    ...
                    <div
                        ...
                        :class="
                            form.is_size && form.is_color ? 'col-2' : 'col-2'
                        "
                    >
                        <b>MRP</b>
                    </div>
                ...
                <div
                    class="row"
                    v-for="(qt, index) in form.attrqty"
                    :key="index"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            <option
                                v-for="(value, index) in prp_colour"
                                :value="value.value"
                                :key="index"
                            >
                                {{ value.name }}
    ...
    <media-helper :setImg="selectImage">
        <template v-slot:viewimage>
            <div
                ...
                v-for="(itm, index) in this.form.selectedImages"
                :key="index"
            >
                <img :src="itm" class="rounded" style="width: 70%" />
                <button
                    type="button"
                    @click="() => this.form.selectedImages.splice(index, 1)"
                    class="close text-danger image-close"
                    aria-label="Close"
                >
