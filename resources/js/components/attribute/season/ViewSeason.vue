                                ...
                                <template v-for="(season,index) in seasons.data" :key="season.id">
                                    <tr>
                                        ...
                                        <td v-if="showPermission.includes('attribute-edit') || showPermission.includes('attribute-delete')">
                                            <button type="button" v-if="showPermission.includes('attribute-edit')" class="btn btn-sm btn-info-a" data-toggle="modal" data-target="#seasonModal" @click="editSeason(season)">Edit</button>
                                            <button type="button" v-if="showPermission.includes('attribute-delete')" class="btn btn-sm btn-delete ml-2" @click="deleteSeason(season.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
