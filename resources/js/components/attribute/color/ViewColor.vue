    ...
    setup() {
        ...
        const getColour = async (page = 1) => {
            let res = await axios.get(
                baseUrl +
                    `colour/create?&keyword=${keyword.key}&per_page=10&page=${page}`
            );
        ...
        const updateColor = async () => {
            try {
                await axios
                    .patch("colour/" + color_id.value, form)
                    .then((response) => {
                        $("#ColorModal").modal("hide");
                        fireToast(response.data);
                        formReset();
                ...
                <div class="widget-content widget-content-area">
                    <div class="d-flex flex-row col-4 mb-2">
                        <input
                            ...
                            @keyup.prevent="onPress"
                            v-model="keyword.key"
                        />
                        <button
                            type="button"
                            class="btn btn-info-a btn-sm mx-3"
                            @click="clearfilter"
                        >
                            CLEAR
                        </button>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover mb-4">
                            ...
                            <tbody>
                                <template
                                    v-for="(color, index) in colours.data"
                                    :key="color.id"
                                >
                                    <tr>
                                        <td>{{ index + 1 }}</td>
                        ...
                        <div class="widget-content widget-content-area">
                            <form>
                                <div class="form-group">
                                    ...
                                    <span
                                        v-if="
                                            errors.hasOwnProperty('color_name')
                                        "
                                        class="text-danger"
                                    >
                                        {{ errors.color_name[0] }}
