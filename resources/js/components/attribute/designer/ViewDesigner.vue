    ...
    setup() {
        ...
        const getDesigner = async (page = 1) => {
            let res = await axios.get(
                baseUrl + `designers/create?page=${page}`
            );
        ...
        const updateDesigner = async () => {
            try {
                await axios
                    .patch("designers/" + designer_id.value, form)
                    .then((response) => {
                        $("#designerModal").modal("hide");
                        fireToast(response.data);
                        formReset();
                    ...
                    <div class="row">
                        ...
                        >
                            ...
                            <button
                                ...
                                v-if="
                                    showPermission.includes('attribute-create')
                                "
                                data-toggle="modal"
                ...
                <div class="widget-content widget-content-area">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover mb-4">
                            ...
                            <tbody>
                                <template
                                    v-for="(designer, index) in designers.data"
                                    :key="designer.id"
                                >
                                    <tr>
                                        <td>{{ index + 1 }}</td>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        v-model="form.designer_sort_name"
                                        id="designer_sort_name"
