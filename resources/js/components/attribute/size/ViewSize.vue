                            ...
                            <tbody>
                                <template v-for="(size,index) in sizes.data" :key="size.id">
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#sizeModal" @click="editSize(size)">Edit</button>
                                            <button type="button" class="btn btn-sm btn-danger ml-2" @click="deleteSize(size.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
