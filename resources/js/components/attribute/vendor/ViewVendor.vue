                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between">
                            <h4>Vendor</h4>
                            <button class="btn btn-info-a mb-2 mr-3" v-if="showPermission.includes('attribute-create')" data-toggle="modal" data-target="#vendorModal" @click="formReset">Add New</button>
                        </div>                          
                    </div>
                </div>       
                        ...
                        <!-- <div class="widget-content widget-content-area"> -->
                            <form>
                                ...
                                <div class="modal-footer md-button">
                                    ...
                                    <button v-if="vendor_id == ''" type="button" class="btn btn-info-a" @click="storeVendor">Submit</button>
