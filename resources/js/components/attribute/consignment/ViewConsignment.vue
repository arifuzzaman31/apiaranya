                                ...
                                <template v-for="(consig,index) in consignments.data" :key="consig.id">
                                    <tr>
                                        ...
                                        <td v-if="showPermission.includes('attribute-edit') || showPermission.includes('attribute-delete')">
                                            <button type="button" v-if="showPermission.includes('attribute-edit')" class="btn btn-sm btn-info-a" data-toggle="modal" data-target="#consignmentModal" @click="editFit(consig)">Edit</button>
                                            <button type="button" v-if="showPermission.includes('attribute-delete')" class="btn btn-sm btn-delete ml-2" @click="deleteConsignment(consig.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
