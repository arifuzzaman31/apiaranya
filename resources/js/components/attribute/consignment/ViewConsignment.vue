                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between">
                            <h4>Consignment</h4>
                            <button class="btn btn-info-a mb-2 mr-3" v-if="showPermission.includes('attribute-create')" data-toggle="modal" data-target="#consignmentModal" @click="formReset">Add New</button>
                        </div>                          
                    </div>
                </div>       
                                ...
                                <template v-for="(consig,index) in consignments.data" :key="consig.id">
                                    <tr>
                                        ...
                                        <td v-if="showPermission.includes('attribute-edit') || showPermission.includes('attribute-delete')">
                                            <button type="button" v-if="showPermission.includes('attribute-edit')" class="btn btn-sm btn-info-a mx-2 my-2" data-toggle="modal" data-target="#consignmentModal" @click="editFit(consig)">Edit</button>
                                            <button type="button" v-if="showPermission.includes('attribute-delete')" class="btn btn-sm btn-delete mx-2" @click="deleteConsignment(consig.id)">Delete</button>
                                        </td>
                                    </tr>					
                                </template>
                            </tbody>
                        ...
                        <div class="widget-content widget-content-area">
                            <form>
                                ...
                                <div class="modal-footer md-button">
                                    ...
                                    <button v-if="consignment_id == ''" type="button" class="btn btn-info-a" @click="storeConsignment">Submit</button>
