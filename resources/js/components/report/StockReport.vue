...
export default {
    ...
    methods: {
        getStockReport(page = 1){
            axios.get(baseUrl+`get-stock-report?page=${page}&per_page=10&keyword=${this.search}&from=${this.filterdata.from}&to=${this.filterdata.to}`)
            .then(result => {
        ...
        <div class="statbox">
            ...
            <div class="widget-content widget-content-area">
                <div class="row mb-2">
                    ...
                    <div class="col-md-2 col-lg-2 col-12">
                        <select id="product-camp" class="form-control form-control-sm" @change="getStockReport()" v-model="filterdata.order_state">
                            <option selected="" value="">Choose...</option>
