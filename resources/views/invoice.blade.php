...
<html lang="en">
  ...
  <body>
    ...
    <td style="width: 80%;border:none"></td>
        ...
        <p style="display:flex; column-gap:6px;align-items:center;color: #545255"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
        ...
        <p  style="display:flex; column-gap:6px;align-items:center;color: #545255"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
    ...
    <table>
      <tr>
        <td style="border: none; color: #272627cc;font-size:19px;font-weight:bolder">
          INVOICE NO: #{{$order_info->id}}
        </td>
        <th style="border: none"></th>

        <td style="border: none; color: #272627cc;font-size:19px;font-weight:bolder;text-align:right"> DATE: {{ $order_info->order_date }}</td>
      </tr>
      ...
      <tr>
        ...
        <td style="border: none; color: #272627cc;font-size:19px;font-weight:bolder;text-align:right"> PAYMENT METHOD</td>
      </tr>
      <tr style="border: none; background-color: #fff">
        <td style="border: none; color: #272627cc;">
      ...
      <tr style="border: none; background-color: #fff">
        <td style="border: none; color: #272627cc;">
            Address: {{ $order_info->user_shipping_info->street_address }},{{ $order_info->user_shipping_info->city }},{{ $order_info->user_shipping_info->country }}
        </td>
        <th style="border: none"></th>
    ...
    <table style="margin-top: 2rem">
      <tr style="background-color: #3b5576; border: none">
        ...
        <th style="border: none; color: #ffffff;text-align:center">WEIGHT(gm)</th>
    ...
    >
     ...
     <tr style="border: none;font-size:19px;font-weight:bolder">
