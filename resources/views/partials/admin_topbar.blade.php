        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-text">
                <a href="{{ url('admin/dashboard') }}">
                    <img src="{{ asset('admin-assets/assets/img/new.png')}}" class="navbar-logo" alt="logo">
                </a>
            </li>
            <!-- <li class="nav-item theme-text">
                <a href="{{ url('admin/dashboard') }}" class="nav-link"></a>
                <a href="{{ url('admin/dashboard') }}" class="nav-link"><img src="{{asset('admin-assets/assets/img/aranya-logo-dark.png')}}"> </a>
            </li> -->
